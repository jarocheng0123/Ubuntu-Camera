...
CAMERA="Vitai" # 相机名称
# WORK_DIR="${USER_HOME}/${CAMERA}" # 工作目录不带日期
...
# NUM_PY_VERSION="1.24.4" # NumPy版本
# OPENCV_VERSION="4.10.0.84" # OpenCV版本
# PYUSB_VERSION="1.2.1" # PyUSB版本
# PICAMERA2_VERSION="0.3.25" # Picamera2版本
# PSUTIL_VERSION="5.9.5" # Psutil版本
# CYTHON_VERSION="3.0.11" # Cython版本
...
# 脚本文件名，脚本定义在下面声明里
CAMERA_DEVICE_DETECTION="camera_device_detection.py" # 相机设备检测
CAMERA_PREVIEW_AND_INFO="camera_preview_and_info.py" # 相机预览和信息
CAMERA_PARAMETER_DEFINITION="camera_parameter_definition.py" # 相机参数定义
OPENCV_CAMERA_DEBUGGER="opencv_camera_debugger.py" # OpenCV相机调试
V4L2_CAMERA_QUICK_SETTER="v4l2_camera_quick_setter.py" # V4L2相机快速设置
V4L2_SINGLE_CAMERA_CONTROLLER="v4l2_single_camera_controller.py" # V4L2单摄像头控制器
V4L2_MULTI_CAMERA_DEBUGGER="v4l2_multi_camera_debugger.py" # V4L2多摄像头调试
...
# 输出脚本说明
# echo -e "\n\033[1;31m 相机调试脚本说明\033[0m"
echo
echo -e "\033[1;31m 相机调试脚本会删除并重建 ${WORK_DIR} 文件夹，并安装 Python ${VERSIONS[PYTHON]} \033[0m"
# echo -e "\033[1;31m 相机调试脚本会删除并重建 ${WORK_DIR} 文件夹\033[0m"
# echo -e "\033[31m==========================================================\033[0m"
# print_separator


# echo -e "\033[33m本脚本会删除并重建 ${WORK_DIR} 文件夹，如果存在，请先备份\033[0m"
# echo # 输出空行

# print_separator
# echo -e "\033[33m虚拟环境           ${PYTHON_VENV}\033[0m"
# echo -e "\033[33m${CAMERA}相机画面预览      ${PYTHON_TO_DESKTOP_PARAMETER} \033[0m"
# echo -e "\033[33m${CAMERA}无画面参数设置      ${PYTHON_TO_DESKTOP_QUICK_SETTING} \033[0m"
# echo -e "\033[33m${CAMERA}多摄像头调试    ${PYTHON_TO_DESKTOP_MULTI_CAMERA_DEBUG} \033[0m"
# echo -e "\033[33m 
# PYTHON_TO_DESKTOP_PARAMETER="${USER_DESKTOP}/${CAMERA}相机预览.desktop"
# echo -e "\033[31m==========================================================\033[0m"
print_separator
# 系统级依赖说明
# echo # 输出空行
echo -e "\033[1;34m系统级依赖（通过 apt 安装）\033[0m"
# echo -e "  \033[32mPython ${PYTHON_VERSION} :\033[0m python${PYTHON_VERSION} python${PYTHON_VERSION}-dev python${PYTHON_VERSION}-venv python${PYTHON_VERSION}-tk"
...
# echo -e "  \033[32m图形界面 :\033[0m tk-dev tcl-dev libqt5gui5 qtbase5-dev"
...
# echo # 输出空行
# echo -e "  \033[32mNumPy:\033[0m ${NUM_PY_VERSION}"
# echo -e "  \033[32mPyUSB:\033[0m ${PYUSB_VERSION}"
# echo -e "  \033[32mPicamera2:\033[0m ${PICAMERA2_VERSION}"
# echo -e "  \033[32mPsutil:\033[0m ${PSUTIL_VERSION}"
# echo -e "  \033[32mCython:\033[0m ${CYTHON_VERSION}"
# echo -e "  \033[32mOpenCV-Python:\033[0m ${OPENCV_VERSION}"


echo -e "  \033[32mNumPy:\033[0m ${VERSIONS[NUM_PY]}"
echo -e "  \033[32mPyUSB:\033[0m ${VERSIONS[PYUSB]}"
# echo -e "  \033[32mPicamera2:\033[0m ${VERSIONS[PICAMERA2]}"
echo -e "  \033[32mPsutil:\033[0m ${VERSIONS[PSUTIL]}"
# echo -e "  \033[32mCython:\033[0m ${VERSIONS[CYTHON]}"
echo -e "  \033[32mOpenCV-Python:\033[0m ${VERSIONS[OPENCV]}"
echo -e "  \033[32mPrettytable:\033[0m ${VERSIONS[PRETTYTABLE]}"
# echo -e "  \033[32m附加包:\033[0m PyQt5 prettytable"
# echo -e "  \033[32m附加包:\033[0m prettytable"
...
# # 设备查看部分
# echo -e "\033[1;34m设备查看\033[0m"
# # echo # 输出空行
# printf "  \033[33m%-40s \033[0m%s\n" "查找目标设备" " lsusb | grep \"${CAMERA}\""
# printf "  \033[33m%-40s \033[0m%s\n" "查看设备列表" " v4l2-ctl --list-devices"
# printf "  \033[33m%-40s \033[0m%s\n" "摄像头参数" "v4l2-ctl -d /dev/video0 --all"
...
# echo
# print_info "设备列表" "source ${PYTHON_VENV} && cd ${WORK_DIR} && ls -l && python ${CAMERA_DEVICE_DETECTION}"

# echo -e "\033[33m当前虚拟环境Python版本：$(python --version 2>&1)\033[0m"
# echo -e "\033[33mPython解释器路径：$(which python)\033[0m"
...
# 相机操作部分
echo -e "\033[1;34m脚本声明和操作\033[0m"
# echo # 输出空行
...
if [ -d "$WORK_DIR" ]; then
    ...
    echo -e "\033[31m ${WORK_DIR} 文件夹不存在，开始创建...\033[0m"
    if ! mkdir -p "$WORK_DIR"; then
        echo -e "\033[31m创建文件夹时出错，请检查权限。\033[0m"
        exit 1
    fi
...
# echo
# 检测 Python 相关依赖
# python_version=$(python${PYTHON_VERSION} --version 2>&1)
...
# check_dpkg() {
#     package=$1
#     version=$(dpkg -s "$package" 2>/dev/null | awk '/Version:/ {print $2}')
#     if dpkg -s "$package" 2>/dev/null | grep -q "Status: install ok installed"; then
#         echo -e "  \033[32m$package：已安装，版本：$version\033[0m"
#     else
#         echo -e "  \033[31m$package：未安装\033[0m"
...
# # 检测 Python 开发包
# check_dpkg "python${PYTHON_VERSION}-dev"
# # 检测 Python 虚拟环境包
# check_dpkg "python${PYTHON_VERSION}-venv"
# # 检测 Python Tkinter 相关
# check_dpkg "python${PYTHON_VERSION}-tk"
...
#         "numpy==${NUM_PY_VERSION}" \
#         "pyusb==${PYUSB_VERSION}" \
#         "picamera2==${PICAMERA2_VERSION}" \
...
# echo -e "\033[31mNumPy版本：$(python -c 'import numpy;print(numpy.__version__)' 2>/dev/null || echo '未安装')\033[0m"
# echo -e "\033[31mPicamera2版本：$(python -c 'import picamera2;print(picamera2.__version__)' 2>/dev/null || echo '未安装')\033[0m"
# echo -e "\033[31mPsutil版本：$(python -c 'import psutil;print(psutil.__version__)' 2>/dev/null || echo '未安装')\033[0m"
# echo -e "\033[31mCython版本：$(python -c 'import cython;print(cython.__version__)' 2>/dev/null || echo '未安装')\033[0m"
...
# echo -e "  \033[31mV4L2 版本：$(v4l2-ctl --version 2>/dev/null || echo '未安装')\033[0m"
...
# echo -e "\033[33mPython解释器路径：$(which python)\033[0m"
# print_separator
echo -e "\033[1;34m创建python脚本\033[0m"
# ██████████████████████████████████████████████████████████████████████████████████████████████████████████████████████


# echo -e "\n\033[32m 相机列表脚本 ${CAMERA_DEVICE_DETECTION} \033[0m"
...
# echo -e "\n\033[32m 相机预览脚本 ${CAMERA_PREVIEW_AND_INFO} \033[0m"
...
# echo -e "\n\033[32m 相机参数声明 ${CAMERA_PARAMETER_DEFINITION} \033[0m"
...
# echo -e "\n\033[32m 采用opencv调试 ${OPENCV_CAMERA_DEBUGGER} \033[0m"
...
# echo -e "\n\033[32m 快速设置代码 ${CAMERA_PARAMETER_DEFINITION} \033[0m"
# cat << 'EOF' > "${WORK_DIR}/${CAMERA_PARAMETER_DEFINITION}"
...
def get_supported_controls(device):
    result = subprocess.run(f"v4l2-ctl -d {device} -l", shell=True, capture_output=True, text=True)
    supported_controls = []
    for line in result.stdout.splitlines():
...
def set_camera_params(index, params, mode):
    device = f"/dev/video{index}"
    supported_controls = get_supported_controls(device)
    for param in params:
        ...
        if mode == "default":
            ...
            continue
        cmd = f"v4l2-ctl -d {device} --set-ctrl={param['v4l2_param']}={val}"
...
# echo -e "\n\033[32m 采用v4l2设置 ${V4L2_SINGLE_CAMERA_CONTROLLER} \033[0m"
...
# echo -e "\n\033[32m 多相机调试脚本 ${V4L2_MULTI_CAMERA_DEBUGGER} \033[0m"
...
# 定义组合信息数组，将文件路径和执行命令组合
# desktop_info=(
#     "${USER_DESKTOP}/${CAMERA}相机画面预览.desktop:source ${PYTHON_VENV} && python ${WORK_DIR}/${CAMERA_DEVICE_DETECTION} && python ${WORK_DIR}/${CAMERA_PREVIEW_AND_INFO}"
#     "${USER_DESKTOP}/${CAMERA}无画面参数设置.desktop:source ${PYTHON_VENV} && python ${WORK_DIR}/${V4L2_CAMERA_QUICK_SETTER}"
#     "${USER_DESKTOP}/${CAMERA}多摄像头调试.desktop:source ${PYTHON_VENV} && python ${WORK_DIR}/${CAMERA_DEVICE_DETECTION} && python ${WORK_DIR}/${CAMERA_PREVIEW_AND_INFO} && python ${WORK_DIR}/${V4L2_MULTI_CAMERA_DEBUGGER}"
# )
...
desktop_info=(
    ...
    #  "${PYTHON_TO_DESKTOP_MULTI_CAMERA_DEBUG}:source ${PYTHON_VENV} && python ${WORK_DIR}/${CAMERA_DEVICE_DETECTION} && python ${WORK_DIR}/${CAMERA_PREVIEW_AND_INFO} && python ${WORK_DIR}/${V4L2_MULTI_CAMERA_DEBUGGER}"
...
# echo -e "\n\033[1;32m ${CAMERA}相机画面预览 ${PYTHON_TO_DESKTOP_PARAMETER} \033[0m"
...
# Version=1.0
# Type=Application
# Name=CAMERA_PREVIEW_AND_INFO 
# Comment=Camera Debug Environment
# Exec=bash -c \"source ${PYTHON_VENV} && python ${WORK_DIR}/${CAMERA_DEVICE_DETECTION} && python ${WORK_DIR}/${CAMERA_PREVIEW_AND_INFO}\"
# Terminal=true
# Categories=Development;Education; "

# # 写入 .desktop 文件
# echo "$PYTHON_TOT_DESKTOP" > "$PYTHON_TO_DESKTOP_PARAMETER"
# chown "$CURRENT_USER:$CURRENT_USER" "${PYTHON_TO_DESKTOP_PARAMETER}"
# chmod 755 "${PYTHON_TO_DESKTOP_PARAMETER}"
...
# echo -e "\n\033[1;32m ${CAMERA}无画面参数设置 ${PYTHON_TO_DESKTOP_QUICK_SETTING} \033[0m"

# PYTHON_TOT_DESKTOP="[Desktop Entry]
# Version=1.0
# Type=Application
# Name=V4L2_CAMERA_QUICK_SETTER 
# Comment=Camera Debug Environment
# Exec=bash -c \"source ${PYTHON_VENV} && python ${WORK_DIR}/${V4L2_CAMERA_QUICK_SETTER}\"
# Terminal=true
# Categories=Development;Education; "

# # 写入 .desktop 文件
# echo "$PYTHON_TOT_DESKTOP" > "$PYTHON_TO_DESKTOP_QUICK_SETTING"
# chown "$CURRENT_USER:$CURRENT_USER" "${PYTHON_TO_DESKTOP_QUICK_SETTING}"
# chmod 755 "${PYTHON_TO_DESKTOP_QUICK_SETTING}"
...
# echo -e "\n\033[1;32m ${CAMERA}多摄像头调试 ${PYTHON_TO_DESKTOP_MULTI_CAMERA_DEBUG} \033[0m"

# PYTHON_TOT_DESKTOP="[Desktop Entry]
# Version=1.0
# Type=Application
# Name=V4L2_MULTI_CAMERA_DEBUGGER
# Comment=Camera Debug Environment
# Exec=bash -c \"source ${PYTHON_VENV} && python ${WORK_DIR}/${CAMERA_DEVICE_DETECTION} && python ${WORK_DIR}/${CAMERA_PREVIEW_AND_INFO} && python ${WORK_DIR}/${V4L2_MULTI_CAMERA_DEBUGGER}\"
# Terminal=true
# Categories=Development;Education; "

# # 写入 .desktop 文件
# echo "$PYTHON_TOT_DESKTOP" > "$PYTHON_TO_DESKTOP_MULTI_CAMERA_DEBUG"
# chown "$CURRENT_USER:$CURRENT_USER" "${PYTHON_TO_DESKTOP_MULTI_CAMERA_DEBUG}"
# chmod 755 "${PYTHON_TO_DESKTOP_MULTI_CAMERA_DEBUG}"
...
# echo -e "\033[1;33m打开相机实时画面 source ${PYTHON_VENV} && cd ${WORK_DIR} && python ${CAMERA_DEVICE_DETECTION} && python ${CAMERA_PREVIEW_AND_INFO}\033[0m"
