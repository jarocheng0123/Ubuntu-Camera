...
V4L2_MULTI_CAMERA_HD_WEBCAM="hd_webcam.py" # 针对 HD WebCam 的调试
...
PYTHON_TO_DESKTOP_MULTI_CAMERA_HD_WEBCAM="${USER_DESKTOP}/HD WebCam 调试.desktop"
...
echo -e "  \033[32mHD WebCam 参数调试工具\033[0m \033[33m   ${V4L2_MULTI_CAMERA_HD_WEBCAM}:\033[0m        为 HD WebCam 提供调试工具"
...
# ██████████████████████████████████████████████████████████████████████████████████████████████████████████████████████
echo -e "\n\033[1;32m HD WebCam 的调试： ${V4L2_MULTI_CAMERA_HD_WEBCAM} \033[0m"
cat << 'EOF' > "${WORK_DIR}/${V4L2_MULTI_CAMERA_HD_WEBCAM}"
print("\n\033[93m【HD WebCam 的调试】\033[0m\n")
...
desktop_info=(
    ...
    "${PYTHON_TO_DESKTOP_MULTI_CAMERA_HD_WEBCAM}:source ${PYTHON_VENV} && python ${WORK_DIR}/${V4L2_MULTI_CAMERA_HD_WEBCAM}"
)
